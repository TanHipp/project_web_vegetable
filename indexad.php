...
<html lang="en">
  ...
  <body>		
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
		    			<div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">+ 336 089 83</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
						    <span class="text">duongthaitan@gmail.com</span>
					    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">ADMIN TanHipp Food</a>
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-md-12 ftco-animate text-center">
	              ...
	              <h2 class="subheading mb-4">Chúng tôi cam kết chất lượng rau củ &amp; nước ép</h2>
	              <p><a href="shop.html" class="btn btn-primary">XEM THÊM TẠI ĐÂY</a></p>
	            </div>
          ...
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <div class="media-body">
                <h3 class="heading">ĐANG CHUYỂN HÀNG</h3>
                <span>TRÊN ĐƠN HÀNG TRÊN $100</span>
              </div>
            </div>      
          </div>
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
							...
							<div class="col-md-6 order-md-last align-items-stretch d-flex">
								<div class="category-wrap-2 ftco-animate img align-self-stretch d-flex" style="background-image: url(images/category.jpg);">
									<div class="text text-center">
										...
										<p><a href="#" class="btn btn-primary">XEM THÊM CÁC SẢN PHẨM</a></p>
									</div>
								</div>
							</div>
							<div class="col-md-6">
    ...
    <section class="ftco-section">
						...
						<div class="container">
							<div class="row">
							    <div class="col-md-6 col-lg-3 ftco-animate">
										<div class="product">
										<a href="#" class="img-prod"><img class="img-fluid" src="$img" alt="">
												<span class="status">30%</span><div class="overlay"></div>
											</a>
											<div class="text py-3 pb-4 px-3 text-center">
											<h3><a href="#">$ten</a></h3>
											<div class="d-flex">
											<div class="pricing">
											<p class="price"><span class="mr-2 price-dc">$120.00</span><span class="price-sale">$gia</span></p>
											</div>
										</div>

										<a href="admin/class/edit.php?id=$id">Edit</a>
								
										</a>
										
										
										<a href="admin/class/delete.php?id=$id">Xóa</a>
										</a>
										
										<a href="admin/class/create.php?id=$id">Thêm</a>
    	...
    	<div class="container">
          ...
          <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
            ...
            <h2 class="mb-4">Giao dịch trong ngày</h2>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            ...
            <p>Từ bé đến giờ tao chưa bị lần nào như này trích ---kHá Bảnh---</p>
          </div>
        </div>
